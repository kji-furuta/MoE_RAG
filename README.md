...
### 🎉 RAGシステムUI機能強化
- **✅ アコーディオン式引用表示**: 出典の全文表示に対応、200文字以上の長文は自動で折りたたみ
- **✅ マークダウンレンダリング**: Marked.js + DOMPurifyによる安全なHTML変換、見出し・リスト・コード等に対応
- **✅ 技術用語ブーストの透明化**: ハイブリッドスコアの内訳を4つのスコアで個別表示（ベクトル・キーワード・ブースト・最終）
